...
const programs = [
  {
    ...
    description: "After-school tutoring, mentorship, learning materials, and scholarship support to ensure every child has equal access to quality education.",
  ...
  },
  {
    ...
    description: "Breaking barriers through education, confidence-building programs, and mentorship — because educating a girl changes her entire family.",
  ...
  },
  {
    ...
    description: "Regular nutrition drives ensuring children have access to wholesome meals — because a nourished child is a learning child.",
  ...
  },
  {
    ...
    description: "Holistic family support services that strengthen households, enabling parents to keep their children in school and thriving.",
      ...
      {programs.map((prog) => (
        ...
        >
          ...
          <div className="p-5 flex-1 flex flex-col">
            ...
            <p className="text-gray-500 text-sm leading-relaxed flex-1">{prog.description}</p>
            <div className="mt-4 flex items-center text-teal-500 text-sm font-semibold">
