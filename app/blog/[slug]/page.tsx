...
**Why We Keep Going**
People sometimes ask me what drives me. The answer is simple: the smiles. The moment a child walks into class with a new uniform, new books, and a full stomach is why AFJS Trust exists.
...
One girl, eight years old, sharp as a needle, with eyes like she's already figured out the world, told one of our volunteers: "This is the best Diwali I've ever had." She'd never said anything like that before, we were told. She was not the kind of child who said things like that.
...
- **Family Counselling**: We engage directly with parents, grandparents, and community elders to shift attitudes. We present education as an investment that increases a girl's value, prospects, and future earning potential.
...
- During school holidays, weekends, and examination breaks, the meals stop, but hunger does not
...
We document every drive, recording how many meals were served, who received them, and what was prepared, so our donors can see exactly where their money goes.
...
For ₹5,000, you can fund an entire nutrition drive, feeding 80 children for a day.`,
  ...
  "christmas-with-underprivileged-families": {
    ...
    readTime: "3 min",
    image: "/images/hero-community.jpg",
    excerpt: "This Christmas, AFJS Trust celebrated with 60 families in Bhavnagar. A night of music, food, and the kind of joy that money cannot manufacture.",
    content: `Christmas at AFJS Trust is not about religion. It is about community: gathering together, breaking bread, and reminding each other that no one is alone.
...
Beyond the practical support we offer, including school fees, nutrition, and family welfare, celebrations provide something that is harder to quantify: a sense of dignity and belonging. The message we send when we gather together and celebrate is simple: you are valued. You are part of this community. You are not invisible.
...
- **Legal awareness**: Helping families understand their rights to housing, education, and welfare benefits they may not know they're entitled to
...
Not just in memory, but in the daily weight of knowing that the children he'd grown up alongside were still navigating a world that hadn't gotten any easier.
...
And in the lanes behind the main roads, in communities that don't make it onto tourist maps or appear in the promotional literature of the Gujarat government's development narrative, families have been left behind.
...
The one thing these families have in common is that the formal systems, including government welfare programmes, school fee waivers, and health schemes, exist on paper but are practically inaccessible to them. The paperwork is too complex. The offices are too far. The officials too difficult to reach.

This is the gap that AFJS Trust fills.

**The School We Work With**
Our primary education partner is St. Xavier's Primary School in Devbagh, Bhavnagar. It is one of the most respected schools in the city, one that produces children who go on to become engineers, doctors, and business owners.

It is not a school for the poor. It is a school that happens to charge fees that most of the families we support cannot afford. Our job is to bridge that gap and get children from the lanes of Bhavnagar into classrooms that genuinely serve their potential.
...
There are organisations working in Bhavnagar, including government schemes, larger state-level NGOs, and international development programmes. We are not competing with them. We are filling the gaps they leave.
...
Research in developmental psychology has established clearly that chronic poverty generates chronic stress, in adults and in children alike. The uncertainty of not knowing where the next meal comes from, the shame of not having what peers have, the fear of a parent who is overwhelmed and volatile: these are not background noise. They are foreground experiences that shape a child's developing brain.
...
In the meantime, our community spaces, including tutoring centres, nutrition drive venues, and family welfare sessions, are deliberately designed to be warm, consistent, and predictable. For a child whose home life is chaotic, predictability itself is therapeutic.
...
- Children who feel part of a community take more risks in learning. They ask more questions, admit confusion more readily, and engage more fully.
- Community belonging reduces chronic stress, which frees up cognitive bandwidth for learning
- Adults in strong communities monitor children collectively, bringing more eyes, more encouragement, and more accountability
- Communities share information about government schemes, health resources, and educational opportunities that isolated families miss
...
Education accumulates. Every year of quality education a child receives adds to a permanent store of capacity: knowledge, reasoning, confidence, and credentials that compound over a lifetime.
...
Of the children in our direct scholarship programme, over 90% completed the academic year. The children who did not complete did so primarily for family-level reasons, such as sudden migration, medical crises, or family relocation, rather than because they chose to leave school.
...
**Economic pressure**: In households where every member's contribution matters, daughters are often expected to take on domestic work, including cooking, childcare, and household labour, that allows other members to work. School interrupts this. School, from a certain perspective, is a cost and not an investment.
...
**Confidence and life-skills workshops**: Weekly sessions that address practical and psychological barriers including confidence, communication, body safety, legal rights, and career awareness. Girls in our programme report feeling seen and capable in ways they did not before.
...
Our PAN number (AALTA7481L) is what you will need when filing your Income Tax Return (ITR). Please keep your donation receipt safely, as it will have this number printed on it.
