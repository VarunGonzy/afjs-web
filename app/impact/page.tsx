      ...
      <div className="bg-teal-50 border-y border-teal-100 py-14 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <span className="inline-block px-4 py-1.5 bg-teal-100 text-teal-700 text-xs font-bold rounded-full uppercase tracking-widest mb-4">Real Results, Real School</span>
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900">
              Academic proof from <span className="text-teal-500">St. Xavier&apos;s Primary School</span>
            </h2>
          ...
          <div className="flex flex-col md:flex-row items-center gap-10">
            <div className="relative w-full max-w-xs mx-auto shrink-0 rounded-2xl overflow-hidden shadow-2xl border border-gray-200">
              <img src="/images/child-result-1.jpeg" alt="Student progress report — St. Xavier's Primary School, Bhavnagar 2025-26" className="w-full h-auto block" loading="lazy" />
              <div aria-hidden="true" style={{ position: "absolute", top: "11.5%", left: "20%", right: "5%", height: "5%", backdropFilter: "blur(14px)", WebkitBackdropFilter: "blur(14px)", backgroundColor: "rgba(248,248,248,0.85)", borderRadius: "3px" }} />
            </div>
            <div className="space-y-5 max-w-sm">
              ...
              <div className="bg-white rounded-2xl p-5 border border-teal-100 shadow-sm">
                ...
                <p className="text-gray-400 text-sm mt-0.5">Gujarati, Hindi, English, Sanskrit, Social Science, Mathematics, Science &amp; Technology</p>
              </div>
              <div className="bg-teal-900 rounded-2xl p-5 text-white">
                <p className="text-sm leading-relaxed">This child was enrolled at St. Xavier&apos;s through AFJS Trust&apos;s full sponsorship programme — school fees, books, uniform, and nutrition support all covered.</p>
                <p className="text-teal-300 text-xs mt-2 font-semibold">₹25,000/year sponsors one child like this.</p>
              </div>
              <a href="/donate" className="block w-full text-center px-6 py-3.5 bg-coral-400 hover:bg-coral-500 text-white font-bold rounded-full shadow-lg transition-all hover:-translate-y-0.5">Sponsor a Child Now ❤</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 py-12 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {["/images/girl-empowerment-2.jpg", "/images/impact-donation.jpg", "/images/nutrition-kids-3.jpg", "/images/girl-empowerment-3.jpg", "/images/community-food.jpg", "/images/education-laptops.jpg"].map((src, i) => (
