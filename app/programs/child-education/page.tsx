      ...
      <div className="max-w-5xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-10 items-center mb-14">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed mb-4">Volunteer mentors work closely with each child, tracking their progress and providing the academic and emotional support they need to thrive. We also distribute learning materials including notebooks, stationery, and educational resources.</p>
