...
export const metadata: Metadata = {
  ...
  description: "AFJS Trust runs four core programs: Child Education, Girl Empowerment, Food & Nutrition Drive, and Family Welfare — all serving underprivileged communities in Bhavnagar and Ahmedabad.",
};
...
const programs = [
  ...
  },
  {
    ...
    description: "Confidence-building programs, mentorship, and educational scholarships exclusively for girls.",
  ...
  },
  {
    ...
    description: "Holistic family support programs that address economic barriers, helping parents keep their children in school.",
  ...
  return (
    <>
      <div className="bg-gradient-to-br from-teal-950 to-teal-700 pt-28 pb-16 px-4 text-center">
        ...
        <p className="text-teal-100 text-lg max-w-2xl mx-auto">Four pillars of lasting community change — each designed to create a ripple effect that uplifts entire families.</p>
      </div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-10">
        {programs.map((prog, i) => (
          <div key={prog.href} className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className={i % 2 === 1 ? "lg:order-1" : ""}>
              ...
              <div className="flex gap-3">
                <Link href={prog.href} className="px-6 py-3 bg-teal-500 hover:bg-teal-600 text-white font-bold rounded-full transition-colors shadow-md">Learn More</Link>
                <Link href="/donate" className="px-6 py-3 bg-coral-400 hover:bg-coral-500 text-white font-bold rounded-full transition-colors shadow-md">Support This →</Link>
              </div>
            </div>
          </div>
        ))}
