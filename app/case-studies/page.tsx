...
const caseStudies = [
  ...
  },
  {
    ...
    story: [
      ...
      "Over the course of the morning, the team served hot, freshly cooked meals to over 80 individuals, including children, parents, and elderly residents. The AFJS standee banner stood in the rain as a marker for people to find the distribution point.",
    ...
    donor: "Funded by diaspora donors from India, UK, and Germany",
  },
  {
    id: "arjun",
    name: "Arjun",
  ...
  },
  {
    ...
    story: [
      ...
      "What happened next was a complete turnaround. With the financial pressure lifted and focused support in place, Meera and Asha sat their semester exams and both passed. Not just scraped through. Passed with results they could be proud of.",
    ...
    donor: "Sponsored by Nikhitha, AFJS core member based in Germany",
  },
  {
